...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class AddressesController : ControllerBase
    {
        ...
        {
            var addressId = await _createAddressCommandHandler.Handle(command, CancellationToken.None); // CancellationToken sağlandı
            return Ok($"Adres bilgisi başarıyla eklendi. Adres ID: {addressId}");
        }
